								...
								<tr align="left" valign="top">
									...
									<a target="_blank">
											<xsl:attribute name="href">
												<xsl:text>https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/</xsl:text>
									...
									<td width="75"  valign="middle" align="center">
										<a target="_blank">
											<xsl:attribute name="href">
												...
												<!-- Produktivumgebung --> 
												<xsl:text>https://www.geocat.ch/geonetwork/srv/api/records/</xsl:text>
												<xsl:value-of select="gmd:fileIdentifier/gco:CharacterString"/>
...
<!-- Das Textende muss je nach Version angepasst werden: Komplett / Einfach -->													
													<td valign="top" height="26" align="left" width="725" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 20px;font-style:normal; font-weight:normal; color:#FFFFFF; text-decoration:none; line-height:26px">Metadatenkatalog - Komplett</td> 		
												</tr>
											</tbody>
										</table>
									</td>
			...
			<tr>
				<td colspan="2" class="text" bgcolor="#E1E2E3">
					...
					<span style="font-size: 18px;font-weight:bold">
						...
						<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:title/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					</span>
				</td>
			</tr>
<!--Beispielbild - simple-->	
...
<!-- Kurzbeschreibung - simple-->
			...
			<tr>
				<td colspan="2" class="text" bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:abstract/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<br/><br/>
				</td>
			</tr>
<!-- Zweck - full-->
			...
			<tr>
				<td colspan="2" class="text" bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:purpose/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<br/><br/>
				</td>
			</tr>
<!-- Zusatzinformationen - full-->
			<xsl:if test="contains(gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:supplementalInformation/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'], 'e')">
			<tr>
				<td colspan="2" class="text" bgcolor="#E1E2E3" valign="TOP">
					<b>
			...
			<tr>
				<td colspan="2" class="text" bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:supplementalInformation/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<br/><br/>
				</td>
			</tr>
			</xsl:if>
			...
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						...
						<xsl:text disable-output-escaping="no">Sprache</xsl:text>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
					<ul type="circle">
						<xsl:for-each select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:language">
							<li>
								<xsl:choose>
									<xsl:when test="gmd:LanguageCode/@codeListValue = 'ger' ">Deutsch</xsl:when>
									<xsl:when test="gmd:LanguageCode/@codeListValue = 'fre' ">Französisch</xsl:when>
									<xsl:when test="gco:CharacterString = 'ger' ">Deutsch</xsl:when>
									<xsl:when test="gco:CharacterString = 'fre' ">Französisch</xsl:when>
...
<!-- Datum "Alle" - extended-->
			<tr>
				<td width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b> 
						<xsl:text disable-output-escaping="no">Datum&#160; Erstellung</xsl:text>
						<br/>
						<xsl:text disable-output-escaping="no">Datum&#160; Überarbeitung</xsl:text>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
...
<!-- Geobasisdaten - extended-->
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:text disable-output-escaping="no">Geobasisdaten (Bund)</xsl:text>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<xsl:text disable-output-escaping="no">nein</xsl:text>
						</xsl:otherwise>
					</xsl:choose>
					<!--<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/che:basicGeodataID/gco:CharacterString"/>-->
				</td>
					...
					<xsl:choose>
						<xsl:when test="contains(che:MD_geodataTypeCode/@codeListValue, 'oerebRegister')">
							<tr>
								<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
									<b>
									<xsl:text disable-output-escaping="no">ÖREB-Kataster</xsl:text>
									</b>
								</td>
								<td bgcolor="#ffffff" valign="TOP">
									<xsl:text disable-output-escaping="no">Ja</xsl:text>
								</td>
							</tr>
						</xsl:when>
					</xsl:choose>
			...
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:if test="contains(gmd:dataSetURI/gco:CharacterString, '.')">
						<a href="{gmd:dataSetURI/gco:CharacterString}" target="_new">Link</a>
					</xsl:if>
					<!--<xsl:choose>
...
<!--			<tr>
	...
	<!-- Adresse Autor - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:if test="contains(gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/che:CHE_CI_ResponsibleParty/gmd:organisationName/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'], 'Kanton Wallis')">
						<xsl:text disable-output-escaping="no">Kanton Wallis</xsl:text>
					</xsl:if>
					<xsl:if test="not(contains(gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/che:CHE_CI_ResponsibleParty/gmd:organisationName/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'], 'Kanton Wallis'))">
						<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/che:CHE_CI_ResponsibleParty/gmd:organisationName/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					</xsl:if>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/che:CHE_CI_ResponsibleParty/che:organisationAcronym/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/che:CHE_CI_ResponsibleParty/gmd:positionName/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<br/><br/>
					...
					<br/>
					<a href="{gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/che:CHE_CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']}" target="_new">
						<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/che:CHE_CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']"/>
					</a>
					<br/><br/>
				</td>
			</tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<ul type="circle">
						<xsl:for-each select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:topicCategory">
							...
							<li>
								<xsl:choose>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'imageryBaseMapsEarthCover_BaseMaps' ">A1 Basiskarten, Landschaftsmodelle</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'imageryBaseMapsEarthCover_EarthCover' ">A2 Bodenbedeckung, Bodennutzung</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'imageryBaseMapsEarthCover_Imagery' ">A3 Luft-, Satellitenbilder</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'location' ">B Ortsangaben, Referenzsysteme</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'elevation' ">C Höhen</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'boundaries' ">D Politische und administrative Grenzen</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'planningCadastre_Planning' ">E1 Raumplanung, Raumentwicklung</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'planningCadastre_Cadastre' ">E2 Grundstückskataster</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'geoscientificInformation_Geology' ">F1 Geologie</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'geoscientificInformation_Soils' ">F2 Boden</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'geoscientificInformation_NaturalHazards' ">F3 Naturbedingte Risiken</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'biota' ">G Wald, Flora, Fauna</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'oceans' ">H Meere</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'inlandWaters' ">I Gewässer</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'climatologyMeteorologyAtmosphere' ">K Atmosphäre, Luft, Klima</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'environment_EnvironmentalProtection' ">L1 Umweltschutz, Lärm</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'environment_NatureProtection' ">L2 Natur- und Landschaftsschutz</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'society' ">M Bevölkerung, Gesellschaft, Kultur</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'health' ">N Gesundheit</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'structure' ">O Gebäude, Anlagen</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'transportation' ">P Verkehr</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'utilitiesCommunication_Energy' ">Q1 Energie</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'utilitiesCommunication_Utilities' ">Q2 Wasser- und Abfallsysteme</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'utilitiesCommunication_Communication' ">Q3 Kommunikation</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'intelligenceMilitary' ">R Militär, Sicherheit</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'farming' ">S Landwirtschaft</xsl:when>
									<xsl:when test="gmd:MD_TopicCategoryCode = 'economy' ">T Wirtschaftliche Aktivitäten</xsl:when>
									<!-- <xsl:otherwise><xsl:value-of select="gmd:MD_TopicCategoryCode"/></xsl:otherwise> -->
								</xsl:choose>
					...
					<ul type="circle">
						<xsl:for-each select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords">
							<xsl:for-each select="gmd:MD_Keywords/gmd:keyword">
									<li><xsl:value-of select="gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/></li>
								</xsl:for-each>
						</xsl:for-each>
					</ul>
				</td>
...
<!-- Anzahl Objekte - full-->
				...
				<td bgcolor="#ffffff" valign="TOP">
					<table border="0" cellpadding="4" cellspacing="2" style="font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px; font-style: normal; color: #000000; text-decoration: none">
						<tr><td bgcolor="#ffffff" valign="TOP" width="30%"><xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:spatialResolution/gmd:MD_Resolution/gmd:equivalentScale/gmd:MD_RepresentativeFraction/gmd:denominator/gco:Integer"/>
							...
							oder für Rasterdaten: <b><xsl:value-of select="string($label/element[@name='gmd:distance']/label)"/></b>
							</td>
							<td bgcolor="#ffffff" valign="TOP">
	...
	<!-- Referenzsystem - full-->
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:value-of select="string($label/element[@name='gmd:referenceSystemInfo']/label)"/>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:referenceSystemInfo/gmd:MD_ReferenceSystem/gmd:referenceSystemIdentifier/gmd:RS_Identifier/gmd:code/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<xsl:text disable-output-escaping="no">&#160;(</xsl:text>
...
<!-- Erläuterung - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:statement/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
				</td>
			</tr>	
<!-- Datenquelle - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:source/gmd:LI_Source/gmd:description/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
				</td>
			</tr>
<!-- Système de coordonnées source - full-->
			<xsl:if test="contains(gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:source/gmd:LI_Source/gmd:sourceReferenceSystem/gmd:MD_ReferenceSystem/gmd:referenceSystemIdentifier/gmd:RS_Identifier/gmd:code/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'], 'CH')">
				<tr>
					<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
						<b>
							<xsl:text disable-output-escaping="no">Bezugssystem</xsl:text>
						</b>
					</td>
					<td bgcolor="#ffffff" valign="TOP">
						<xsl:value-of select="gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:source/gmd:LI_Source/gmd:sourceReferenceSystem/gmd:MD_ReferenceSystem/gmd:referenceSystemIdentifier/gmd:RS_Identifier/gmd:code/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					</td>
				</tr>		
			</xsl:if>			
			<tr>
...
<!-- Ressourceneinschränkungen - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:resourceConstraints/gmd:MD_Constraints/gmd:useLimitation/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>	
				</td>
			</tr>
...
<!-- Gesetzgebung-->
			<tr>
				<td colspan="2" class="text" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:text disable-output-escaping="no">Gesetzgebung</xsl:text>
					</b>
				</td>
			</tr>
<!-- Title-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="che:legislationInformation/che:CHE_MD_Legislation/che:title/gmd:CI_Citation/gmd:title/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
				</td>
			</tr>
			<tr>
				<td colspan="2" class="text" valign="TOP">
...
<!-- Überarbeitung-->
	...
	<!-- Überarbeitungsbemerkung - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:resourceMaintenance/che:CHE_MD_MaintenanceInformation/gmd:maintenanceNote/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
				</td>
			</tr>
			<tr>
				<td colspan="2" class="text" valign="TOP">
			...
			<tr>
				<td colspan="2" class="text" bgcolor="#E1E2E3" valign="TOP">
					<b>
						...
						<xsl:text disable-output-escaping="no">Objektkatalog und Datenmodell</xsl:text>
					</b>
				</td>
			</tr>
<!-- Objektkatalog und Model - Datum und Link-->
			...
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:text disable-output-escaping="no">Erstellungsdatum</xsl:text>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
			...
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:text disable-output-escaping="no">Link</xsl:text>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
					<a href="{che:dataModel/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']/text()}" target="_new">
						<xsl:value-of select="gmd:featureCatalogueCitation/gmd:CI_Citation/gmd:title/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					</a>
				</td>
			</tr>
			</xsl:for-each>
...
<!-- Darstellungskatalog-->
			<tr>
				<td colspan="2" class="text" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:value-of select="string($label/element[@name='gmd:portrayalCatalogueCitation']/label)"/>
					</b>
				</td>
			</tr>
<!-- Darstellungskatalog - Datum und Link-->
			<xsl:if test="contains(gmd:portrayalCatalogueInfo/che:CHE_MD_PortrayalCatalogueReference/gmd:portrayalCatalogueCitation/gmd:CI_Citation/gmd:title/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'], 'e')">
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:text disable-output-escaping="no">Erstellungsdatum</xsl:text>
			...
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<a href="{gmd:portrayalCatalogueInfo/che:CHE_MD_PortrayalCatalogueReference/che:portrayalCatalogueURL/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']/text()}" target="_new">
						<xsl:value-of select="gmd:portrayalCatalogueInfo/che:CHE_MD_PortrayalCatalogueReference/gmd:portrayalCatalogueCitation/gmd:CI_Citation/gmd:title/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					</a>
				</td>
			</tr>
			</xsl:if>
...
<!-- Vertrieb-->
	...
	<!-- Online Ressource (Internet and OpenData)- full-->		
			<xsl:for-each select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine">
							...
							<xsl:choose>
									<xsl:when test="contains(gmd:CI_OnlineResource/gmd:name/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'],'Geoportal')">
										<tr>
											<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
												<b>
												<!--<xsl:value-of select="string($label/element[@name='gmd:CI_OnlineResource']/label)"/>-->
												<xsl:text disable-output-escaping="no">Geoportal&#160;(Internet)</xsl:text>
												</b>
											</td>
											<td bgcolor="#ffffff" valign="TOP">
												<a href="{gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']}" target="_new">
												<xsl:value-of select="gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']"/>
												</a>
											</td>
										</tr>	
									</xsl:when>
									<xsl:when test="contains(gmd:CI_OnlineResource/gmd:name/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'],'OpenData')">
										<tr>
											<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
												<b>
												<xsl:text disable-output-escaping="no">OpenData Wallis</xsl:text>
												</b>
											</td>
											<td colspan="2" class="text" bgcolor="#ffffff" valign="TOP">
												<a href="{gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']}" target="_new">
									...
									<xsl:when test="contains(gmd:CI_OnlineResource/gmd:name/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'],'Landing Page')">
										
									</xsl:when>
									<xsl:when test="contains(gmd:CI_OnlineResource/gmd:description/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'],'(Interlis)')">
										
									</xsl:when>
									<xsl:when test="contains(gmd:CI_OnlineResource/gmd:name/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE'],'Download')">
									...
									<xsl:otherwise>
										<tr>
											<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
												<b>
												<xsl:text disable-output-escaping="no">Andere Links</xsl:text>
												</b>
											</td>
											<td bgcolor="#ffffff" valign="TOP">
												<a href="{gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL[@locale='#DE']}" target="_new">
	...
	<!-- Online Ressource (intern)- full-->
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:text disable-output-escaping="no">Umgebung&#160;(intern)</xsl:text>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:environmentDescription/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
				</td>
			</tr>
<!-- Code (intern)- full-->
			<tr>
				<td class="text" width="30%" bgcolor="#E1E2E3" valign="TOP">
					<b>
						<xsl:text disable-output-escaping="no">Identifikator&#160;(intern)</xsl:text>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
	...
	<!-- Adresse Vertrieb - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:text disable-output-escaping="no">Kanton Wallis</xsl:text>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorContact/che:CHE_CI_ResponsibleParty/che:organisationAcronym/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorContact/che:CHE_CI_ResponsibleParty/gmd:positionName/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/>
					<br/><br/>
