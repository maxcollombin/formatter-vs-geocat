...
<!-- Das Textende muss je nach Version angepasst werden: Komplett / Einfach -->													
													<td valign="top" height="26" align="left" width="725" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 20px;font-style:normal; font-weight:normal; color:#FFFFFF; text-decoration:none; line-height:26px">Metadatenkatalog - Einfach</td> 		
												</tr>
											</tbody>
										</table>
									</td>
																...
																<tr>
																	<td valign="middle" class="text" height="50">
																		<a target="_blank">																		
																			...
																			<!-- Produktivumgebung-->  <xsl:text>https://www.geocat.ch/geonetwork/srv/api/records/</xsl:text> 
																			<xsl:value-of select="gmd:fileIdentifier/gco:CharacterString"/>
																			<xsl:text>/formatters/vs_full_de?width=_100&amp;mdpath=md.format.pdf&amp;output=pdf&amp;approved=true</xsl:text>
																			</xsl:attribute>
																			Drucken</a>
																	</td>
...
<!--Beispielbild - simple-->	
			<tr>
				<td colspan="2" class="text" bgcolor="#ffffff" valign="TOP">
					...
					<!-- <img src="http://geocat0i.bgdi.admin.ch/geonetwork/srv/deu/resources.get?access=public&amp;id={geonet:info/id}&amp;fname={gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:graphicOverview[1]/gmd:MD_BrowseGraphic/gmd:fileName/gco:CharacterString}" border="0"/> -->
						<p align="center">
