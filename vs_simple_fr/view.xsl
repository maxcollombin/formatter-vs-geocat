                    ...
                    <div class="row g-2">
                        <div class="col-12 col-md-4 d-flex justify-content-center justify-content-md-start">
                            <a class="btn btn-outline-danger btn-sm" 
                               href="{concat($urlBase, $identifier, '/formatters/vs_simple_fr?width=_100&amp;mdpath=md.format.pdf&amp;output=pdf&amp;approved=true')}" target="_blank">Imprimer la fiche (PDF)</a>
                        </div>
                        ...
                        <div class="col-12 col-md-4 d-flex justify-content-center justify-content-md-end">
                            <a class="btn btn-outline-danger btn-sm" 
                               href="{concat($urlBase, $identifier, '/formatters/vs_simple_de?language=ger')}" target="_blank">Version allemande</a>
                        </div>
                    </div>
                </nav>
                <!-- Contenu principal -->
                                ...
                                <table class="table table-bordered table-sm table-striped table-hover align-middle table-50-50">
                                    <tbody>
                                        ...
                                        <xsl:if test="$creationDate">
                                            <tr><th scope="row">Date de création</th><td><xsl:call-template name="formatDate"><xsl:with-param name="date" select="$creationDate"/></xsl:call-template></td></tr>
                                        </xsl:if>
