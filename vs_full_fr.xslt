            ...
            <body>
                ...
                <main>
                    <nav class="presentation-nav">
                        <a href="{concat($urlBase, $identifier, '/formatters/vs_simple_fr?width=_100&amp;mdpath=md.format.pdf&amp;output=pdf&amp;approved=true')}" 
                        ...
                        <div class="language-link">
                            <a href="{concat($urlBase, $identifier, '/formatters/vs_simple_de?language=ger')}" 
